...
//  火星坐标系转换扩展
/*
 从 GHBLocationManager 取出来的经纬度放到 mapView 上显示，是错误的!
 从 GHBLocationManager 取出来的经纬度去 Google Maps API 做逆地址解析，当然是错的！
 ...
 火星坐标: MKMapView
 地球坐标: GHBLocationManager
 
 当用到GHBLocationManager 得到的数据转化为火星坐标, MKMapView不用处理
...
@interface CLLocation (GHBLocation)
